...
rtree_node_alloc_t *JET_MUTABLE
rtree_node_alloc = rtree_node_alloc_impl;
...
UNUSED rtree_node_dalloc_t
*
JET_MUTABLE rtree_node_dalloc =
...
rtree_leaf_alloc_t *JET_MUTABLE
rtree_leaf_alloc = rtree_leaf_alloc_impl;
...
UNUSED rtree_leaf_dalloc_t
*
JET_MUTABLE rtree_leaf_dalloc =
