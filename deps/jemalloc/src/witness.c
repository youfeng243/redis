...
witness_lock_error_t *JET_MUTABLE
witness_lock_error = witness_lock_error_impl;
...
witness_owner_error_t *JET_MUTABLE
witness_owner_error =
...
witness_not_owner_error_t *JET_MUTABLE
...
witness_depth_error_t *JET_MUTABLE
witness_depth_error =
