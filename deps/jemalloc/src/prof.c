...
prof_dump_open_t *JET_MUTABLE
prof_dump_open = prof_dump_open_impl;
...
prof_dump_header_impl(tsdn_t *tsdn, bool propagate_err,
    ...
    if (prof_dump_printf(propagate_err,
                         ...
                         "  t*: %"FMTu64": %"FMTu64" [%"FMTu64": %"FMTu64"]\n",
                         ((uint64_t)
        1U << lg_prof_sample), cnt_all->curobjs,
...
prof_dump_header_t *JET_MUTABLE
prof_dump_header = prof_dump_header_impl;
...
prof_tdata_init_impl(tsd_t *tsd, uint64_t thr_uid, uint64_t thr_discrim,
    ...
    tdata->prng_state = (uint64_t)(uintptr_t)
    tdata;
    prof_sample_threshold_update(tdata);
